...
public class ObjectFactory {
    ...
    private final static QName _SayHi_QNAME = new QName("http://server.ios/", "sayHi");
    private final static QName _SayHiResponse_QNAME = new QName("http://server.ios/", "sayHiResponse");
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://server.ios/", name = "sayHi")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://server.ios/", name = "sayHiResponse")
